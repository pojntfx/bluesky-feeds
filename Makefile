...
build/function: depend/signature $(addprefix build/function/,$(functions))
...
$(addprefix depend/signature/,$(signatures)):
	...
	mkdir -p signatures/$(subst depend/signature/,,$@)/go/guest signatures/$(subst depend/signature/,,$@)/go/host signatures/$(subst depend/signature/,,$@)/rust/guest
	...
	scale --no-telemetry signature export local/$(subst depend/signature/,,$@):latest go host signatures/$(subst depend/signature/,,$@)/go/host
